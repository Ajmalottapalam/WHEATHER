function getWeather(city) {
    ...
    function displaydata(dataArray) {
        ...
        result.innerHTML = `<div class="card" style="width: 100% bg-dark">
                            ...
                            <div class="row">
                            <div class="col-6">
                            <li><img src="./images/1.png" alt="" id="img"></li>
                            </div>
                            <div class="col-6">
...
<center>
             <li class="list-group-item" id="city">    ${city}</li>
                            ...
                            <li class="list-group-item">Feels like: ${(dataArray.main.feels_like - 32) / 1.8} <span><sup>°</sup>C</span.</li>
...
function getLocation() {
    ...
    function success(location) {
        ...
        <li><img src="./images/2.png" alt="" id="img"></li>
